...
void MyStack::on_saveButton_clicked()
{
    QFile writeFile("F:\\Qt\\Documents\\Data_2_0\\resource\\mystack.txt");
...
void MyStack::on_loadButton_clicked()
{
    destorySelf();
    initMyStack();
    ui->pushButtonClear->setEnabled(true);
    ...
    ui->lineEditLocate->setEnabled(true);
    qDebug()<< " ****" << endl;
    QFile readFile("F:\\Qt\\Documents\\Data_2_0\\resource\\mystack.txt");
